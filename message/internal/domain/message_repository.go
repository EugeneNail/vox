...
type MessageRepository interface {
	...
	FindLastByChatUuid(ctx context.Context, chatUuid uuid.UUID) (*Message, error)
	ListFromRevision(ctx context.Context, chatUuid uuid.UUID, revision int64) ([]Message, error)
