...
import (
	...
	validation "github.com/EugeneNail/vox/auth/internal/infrastructure/validation"
...
func (handler *Handler) CreateUser(request *http.Request) (int, any) {
	...
	if err := validator.Validate(); err != nil {
		...
		return http.StatusBadRequest, fmt.Errorf("validating create user payload: %w", err)
	}
