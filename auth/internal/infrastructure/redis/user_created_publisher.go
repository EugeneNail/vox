...
func (publisher *UserCreatedPublisher) Publish(ctx context.Context, event domain.UserCreatedEvent) error {
...
var _ domain.UserCreatedPublisher = (*UserCreatedPublisher)(nil)
